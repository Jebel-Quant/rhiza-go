...
You can customize the API documentation generated by `godoc`.

### Project Logo

The documentation includes a logo. You can override the default logo (`assets/rhiza-logo.svg`) by setting the `LOGO_FILE` variable in your Makefile or `local.mk`:
